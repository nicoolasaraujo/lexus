...
class HomeModule extends ModuleWidget {
  ...
  List<Bloc> get blocs => [
        ...
        Bloc((i) => ClassroomRegisterBloc(HomeModule.to.getBloc<HomeBloc>(),
            HomeModule.to.getDependency<ClassroomRepository>())),
        Bloc((i) => StudentBloc(HomeModule.to.getBloc<HomeBloc>(),
            HomeModule.to.getDependency<StudentRepository>()))
      ];
  ...
  List<Dependency> get dependencies => [
        ...
        Dependency((i) =>
            StudentRepository(AppModule.to.getDependency<SqfliteAdapter>()))
      ];
